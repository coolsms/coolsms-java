...
public class SendChingutalkOneButtonWebLink {
    public static void main(String[] args) {
        ...
        // buttons.add(new KakaoButtonItem("배송조회", "DS", null, null, null, null)); // 친구톡에서 발송 불가
        ...
        buttons.add(new KakaoButtonItem("홈페이지", "WL", "https://m.example.com", "https://example.com", null, null));
